    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold" style={{ color: theme.text }}>Create New Board</h2>
          <button onClick={onClose} className="p-2.5 rounded-full bg-red-500 hover:bg-red-600 text-white">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium mb-2" style={{ color: theme.textSecondary }}>Board Name</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label className="block text-sm font-medium mb-3" style={{ color: theme.textSecondary }}>Icon</label>
          ...
          <div className="flex gap-3 pt-4">
            ...
            >
              {loading ? <><Loader2 className="w-5 h-5 spinner" />Creating...</> : 'Create'}
            </button>
          </div>
        </form>
      </div>
